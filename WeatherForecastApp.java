...
public class WeatherForecastApp {
    ...
    private static final String TARGET_URL =
            "https://www.jma.go.jp/bosai/forecast/data/forecast/270000.json"; // 天気予報APIのURL（大阪府）
    ...
    public static void main(String[] args) {
        try {
            ...
            URL url = URL.of(URI.create(TARGET_URL), null);
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                JSONArray weathersArray = timeSeriesObject.getJSONArray("areas")
